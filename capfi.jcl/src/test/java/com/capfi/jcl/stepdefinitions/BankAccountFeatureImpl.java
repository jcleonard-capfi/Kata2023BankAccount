...
import com.capfi.jcl.model.AccountOperation;
import com.capfi.jcl.model.AccountOperationSnapshot;
import com.capfi.jcl.model.BankAccount;
import com.capfi.jcl.model.BankAccountImpl;
import com.capfi.jcl.model.FunctionalException;
...
public class BankAccountFeatureImpl {
	...
	String status = "";
	private List<AccountOperationSnapshot> history;
	
	@Given("As a bank new client")
	public void as_a_bank_new_client() {
		System.out.println("Creating new Account");
		this.ba = new BankAccountImpl();
	}
	...
	public void i_deposit_for_the_on_my_account(String action, Double d) throws FunctionalException {
	    ...
	    if (action.equalsIgnoreCase("DEPOSIT")) {
	    	ba.doDeposit(BigDecimal.valueOf(d));
	    } else if (action.equalsIgnoreCase("DEPOSIT")) {
	    	ba.doWithdrawal(BigDecimal.valueOf(d));
	    } 
	    status = "OK";	
	}
	...
	public void i_want_to_retrieve_the_history() {
	    ...
	    for( AccountOperationSnapshot ao  :  history ) {
